...
const htmls = {
  ...
  <div class="profile-author">
    <div class="header">
      ...
      ${(connection) ? 'https://github.com/andremalveira.png' : getImage('svg/astronaut.svg')}
      "></div></a>
  ...
  <div class="credits">
    ...
    <div class="container-item">
      ...
      <div class="item">
        <i style="color:#60be86">${icons.dot}</i>
        <a href="https://devicon.dev" target="_blank"><span>DEVICON</span></a>
      </div>
      <div class="item">
      ...
      <div class="item">
        <i style="color:#9723ac">${icons.dot}</i>
        <a href="https://github.com/ritwickdey/live-server-web-extension" target="_blank"><span>Live Server Web Extension</span></a>
      </div>
      <div class="item">
